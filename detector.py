...
class ObjectDetector:
    ...
    def detect(self, frame):
        """
        Menjalankan inferensi pada frame (BGR OpenCV).
        Returns:
    ...
    def get_closest_by_label(self, detections, label):
        """
        Dari list deteksi, ambil objek dengan label tertentu
        yang paling dekat ke kapal (cy paling besar = paling bawah di frame).
        Returns: dict deteksi atau None
        """
